...
const HomeScreen = () => {
  ...
  return (
    <div className="h-screen overflow-hidden flex flex-col items-center relative bg-black">
      ...
      <header className="z-10 md:w-[57%] w-[90%] flex justify-between items-center text-lg p-3 mt-4">
        ...
        <button className="group relative px-4 py-2 text-black bg-white cursor-pointer w-36 overflow-hidden h-[40px] rounded-[6px] text-sm font-[poppinmed]">
  ...
  muted
  playsInline
  className="relative aspect-square md:w-[400px] w-4/5 mt-10 object-cover mx-auto mix-blend-screen opacity-90 brightness-200 contrast-125"
/>
