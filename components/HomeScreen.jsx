  ...
  return (
    <div className="min-h-screen flex flex-col items-center relative overflow-hidden">
      ...
      >
        ...
        {/* Book Meeting Button */}
        <button className="group md:block hidden relative px-4 py-2 text-black bg-white cursor-pointer w-36 overflow-hidden group h-[40px] rounded-[6px] text-sm font-[poppinmed]">
