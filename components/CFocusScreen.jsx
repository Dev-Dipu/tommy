...
const CFocusScreen = () => {
  return (
    <section
      className="h-screen flex flex-col items-center gap-20 text-white relative"
    >
      ...
      <div className='z-10 flex flex-col items-center gap-6'>
        <h2 className='md:text-5xl text-[4.5vw] text-center md:w-2/3 w-[95%] mt-14 font-[poppinmed] text-white leading-snug text-nowrap'>Services Built for Growth</h2>
      <p className='text-center md:w-[45%] w-[95%] mb-4'>AI-powered solutions and creative expertise designed to help your business scale smarter, faster, and more efficiently.</p>
      <Button text="Book Meeting" />
      </div>
