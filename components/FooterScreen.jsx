...
const FooterScreen = () => {
  ...
  muted
  playsInline
  className="absolute w-1/2 aspect-square left-1/2 bottom-0 -translate-x-1/2 translate-y-1/2 -z-10 object-cover mx-auto mix-blend-screen opacity-90 brightness-200 contrast-125"
/>
